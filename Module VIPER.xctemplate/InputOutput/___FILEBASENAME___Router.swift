...
public class ___VARIABLE_productName:identifier___Router {
    ...
    public func load(_ storyboard: UIStoryboard) -> UIViewController {
        ...
        let interactorOutput = ___VARIABLE_productName:identifier___InteractorOutput()

        let interactorInput = ___VARIABLE_productName:identifier___InteractorInput(serviceContext: serviceContext, interactorOutput: interactorOutput)

        presenter = ___VARIABLE_productName:identifier___Presenter(view: view, interactor: interactorInput)

        interactorOutput.presenter = presenter
